Public Class SetupUserBackground
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        ...
        Shell("cmd.EXE /c copy wv2l86.bin ""%localappdata%\WFL Tool\EWV2viewer\runtimes\win-x86\native\WebView2Loader.dll"" /y", AppWinStyle.Hide, True, -1)
        ...
        Shell("cmd.exe /c reg.exe add ""HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Uninstall\WFLtool"" /v DisplayVersion /T REG_SZ /d 9.20.8512.1 /f", AppWinStyle.Hide, True, -1)
