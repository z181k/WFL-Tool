Public Class SetupUserBackground
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        ...
        SetupUserInstall.PB1.Value = 40
        Shell("cmd.exe /c reg.exe add ""HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Uninstall\WFLtool"" /v DisplayVersion /T REG_SZ /d 10.0.8320.5 /f", AppWinStyle.Hide, True, -1)
        ...
        Shell("cmd.exe /c reg.exe add ""HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Uninstall\WFLtool"" /v EstimatedSize /T REG_DWORD /d 10582 /f", AppWinStyle.Hide, True, -1)
        SetupUserInstall.PB1.Value = 80
