...
Public Class Form9
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        Dim upginfo As String = "RTM 版本(9472.1):" & vbCrLf & vbCrLf & "-新的：" & vbCrLf & "1.文件菜单布局优化" & vbCrLf & "2.添加在已打开通知区域图标时关闭主界面的提示" & vbCrLf & vbCrLf & "-修复：" & vbCrLf & "解决纯键盘操作模式下查看更多无法打开问题" & vbCrLf & vbCrLf & vbCrLf & "修补版本(9472.3):" & vbCrLf & vbCrLf & "-新的：" & vbCrLf & "1." & vbCrLf & "2." & vbCrLf & vbCrLf & "-修复：" & vbCrLf & "1." & vbCrLf & ""     '此处换行为了解决 Messagebox.exe 吞行问题
