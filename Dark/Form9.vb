...
Public Class Form9
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        Dim upginfo As String = "RTM 版本(9584.1):" & vbCrLf & vbCrLf & "-新增：" & vbCrLf & "1.新增 Windows 自动更新控制 功能" & vbCrLf & "2.新增拒绝在低于 800×600 分辨率下启动" & vbCrLf & vbCrLf & "-修复：" & vbCrLf & "1.解决多个在低分辨率设备的显示异常问题" & vbCrLf & "2.解决系统附件在弹出式打开下返回快捷键仍能用问题" & vbCrLf & "3.解决多个依赖 WebView2 功能加载异常问题" & vbCrLf & "4.解决从旧版本更新卸载页不显示更改问题" & vbCrLf & "5.解决多个在上个版本出现的影响稳定性和使用体验的问题" & vbCrLf & ""     '此处换行为了解决 Messagebox.exe 吞行问题
