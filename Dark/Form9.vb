...
Public Class Form9
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        Dim upginfo As String = "RTM 版本(9504.1):" & vbCrLf & vbCrLf & "-新的：" & vbCrLf & "1." & vbCrLf & "2." & vbCrLf & vbCrLf & "-修复：" & vbCrLf & "1." & vbCrLf & "2.解决上个版本修复内容对 WinServer 2022 无效问题" & vbCrLf & ""     '此处换行为了解决 Messagebox.exe 吞行问题
