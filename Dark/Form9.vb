...
Public Class Form9
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        Dim upginfo As String = "RTM 版本(9472.1):" & vbCrLf & vbCrLf & "-新的：" & vbCrLf & "1.文件菜单布局优化" & vbCrLf & "2.添加在已打开通知区域图标时关闭主界面的提示" & vbCrLf & vbCrLf & "-修复：" & vbCrLf & "解决纯键盘操作模式下查看更多无法打开问题" & vbCrLf & vbCrLf & vbCrLf & "修补版本(9472.3):" & vbCrLf & vbCrLf & "-新的：" & vbCrLf & "从 v14.3 开始测试的暗色模式推广到所有安装模式和 WinPE 中仍能使用本应用" & vbCrLf & "从该版本开始正式上线！欢迎体验" & vbCrLf & vbCrLf & "-修复：" & vbCrLf & "1.修复 下载新版本 WFL Tool 选项无法使用问题" & vbCrLf & "2.修复为当前用户安装时设置/控制面板卸载条目没有图标问题" & vbCrLf & vbCrLf & vbCrLf & "修补版本(9472.5):" & vbCrLf & vbCrLf & "-新的：" & vbCrLf & "1." & vbCrLf & vbCrLf & "-修复：" & vbCrLf & "1." & vbCrLf & ""     '此处换行为了解决 Messagebox.exe 吞行问题
