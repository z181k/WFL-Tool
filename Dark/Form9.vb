...
Public Class Form9
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        Dim upginfo As String = "RTM 版本(9504.1):" & vbCrLf & vbCrLf & "-新的：" & vbCrLf & "1.主界面可调整大小" & vbCrLf & "2.MSDT 疑难解答功能上线" & vbCrLf & vbCrLf & "-修复：" & vbCrLf & "1.解决使用 Webview2 页面在部分低分辨率屏幕下的显示问题" & vbCrLf & "2.解决上个版本修复内容对 WinServer 2022 无效问题" & vbCrLf & "3.解决和卸载程序有关的多个问题" & vbCrLf & "4.安装程序附带 WinAppSDK 升级至 1.7.8，提高应用稳定性" & vbCrLf & "5.漏洞修复：主程序内嵌 .NET 框架升级到 10.0.103 安全更新版本" & vbCrLf & ""     '此处换行为了解决 Messagebox.exe 吞行问题
