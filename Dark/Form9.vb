...
legacy:
    ...
    Private Sub LinkLabel7_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel7.LinkClicked
        ...
        Else              '旧版弹窗
legacy:
            MsgBox("全名: WFL Tool (x64) Without Dark Theme       版本类别: 正式版 - .NET 10 版本" & vbCrLf & "分支: AMD64.Tree4-Main.Release" & vbCrLf & "编译日期：" + releasedate + vbCrLf & "" & vbCrLf & "WinAppSdk 模块由 Bilibili@空糖_SuGar (UID:438929715) 提供支持" & vbCrLf & "" & vbCrLf & "电脑功能启动器是 WFL Tool 的中文名", MsgBoxStyle.OkOnly, "更多信息")
        End If
    End Sub
