...
Public Class Form9
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        Dim upginfo As String = "RTM 版本(9168.1):" & vbCrLf & "此版本包含 13.0.9120.1 的所有功能和改进，即使 13.0.9120.1 可能会在该版本之后才会发布" & vbCrLf & vbCrLf & "-新的：" & vbCrLf & "1.WFL Tool 现已支持暗色模式！" & vbCrLf & "　仅为当前用户安装可用，需安装 .NET 10 框架" & vbCrLf & "2.文件菜单增加文件浏览功能" & vbCrLf & "3.文件菜单增加沉浸式网页预览功能" & vbCrLf & "4.添加 Win11 恢复旧版打印界面功能" & vbCrLf & "5.添加 mmc 强制适配高 dpi 功能" & vbCrLf & vbCrLf & "-修复：" & vbCrLf & "1.解决电池健康功能需要管理员权限问题" & vbCrLf & "2.解决 设备管理器错误代码帮助 窗口可能标题显示异常问题" & vbCrLf & vbCrLf & vbCrLf & "修补版本(9168.3):" & vbCrLf & vbCrLf & "-新的:" & vbCrLf & "1.Win 10 v2004 及以上版本为当前用户安装时默认打开 .net 10 版本" & vbCrLf & "2.通知区域图标从双击打开变单击打开" & vbCrLf & vbCrLf & "-修复:" & vbCrLf & "解决单文件安装包临时文件清理不干净问题" & vbCrLf & vbCrLf & vbCrLf & "修补版本(9168.5):" & vbCrLf & vbCrLf & "-修复：" & vbCrLf & "1.解决打开电池健康信息时应用等待关闭卡死问题" & vbCrLf & "2.界面体验优化" & vbCrLf & "3.解决附件窗口的可选功能在不支持系统仍然可用问题" & vbCrLf & vbCrLf & vbCrLf & "修补版本(9168.7):" & vbCrLf & vbCrLf & "-新的:" & vbCrLf & "1.添加开启/关闭开机启动项目功能" & vbCrLf & "2.电池健康信息改为浏览器查看" & vbCrLf & vbCrLf & "-修复：" & vbCrLf & "1.离线更新包功能进行了多项优化" & vbCrLf & "2.系统更新菜单中的更新本程序已彻底删除" & vbCrLf & vbCrLf & vbCrLf & "修补版本(9168.8):" & vbCrLf & vbCrLf & "-修复:" & vbCrLf & "解决设置开机启动项目中的诸多问题" & vbCrLf & vbCrLf & vbCrLf & "修补版本(9168.9):" & vbCrLf & vbCrLf & "-新的:" & vbCrLf & "1.系统更新日志离线更新下载覆盖到更多系统" & vbCrLf & "2.文件菜单中新增运行功能" & vbCrLf & vbCrLf & "-修复:" & vbCrLf & "解决指定界面显示会比不支持该系统提示先弹出问题" & vbCrLf & ""     '此处换行为了解决 Messagebox.exe 吞行问题
...
legacy:
    ...
    Private Sub LinkLabel6_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel6.LinkClicked '检查更新
        ...
        Shell("reg.exe add ""HKEY_CURRENT_USER\Software\DBT\WFL Tool"" /v EWV2webpageTitle /T REG_SZ /d ""检查更新 - 请手动下载完整最新版安装包 - WFL Tool 下载中心"" /f", AppWinStyle.Hide, True, -1)
        Shell("reg.exe add ""HKEY_CURRENT_USER\Software\DBT\WFL Tool"" /v EWV2webpageURL /T REG_SZ /d https://medbt-my.sharepoint.cn/:f:/g/personal/dbtob_medbt_partner_onmschina_cn/IgBdYnImsH-5RIqkDkx3h2pCAZaJ_8KKWMkn7g9S3mbt5tM?e=EaTFxL /f", AppWinStyle.Hide, True, -1)      'onedrive链接，方便下载，vip到期就失效，反正旧版win不支持了，链接失效就失效了
        Shell("EWV2viewer\EWV2Viewer.exe", AppWinStyle.NormalFocus, False, -1)   '写入启动参数注册表并且启动ewv2
        Exit Sub
legacy:
        Dim NF4 As New Form4()
        NF4.Show()
        NF4.Text = "检查更新 - WFL Tool"                 'EDGE WEBVIEW2不存在或者无法启动ewv2的旧版方案
        NF4.MaximizeBox = True
        NF4.WebBrowser1.Url = New Uri("https://z181k.lanzoui.com/s/WFL-Tool")        '使用了方便分发的定制链接，vip到期就失效，反正旧版win不支持了，链接失效就失效了
    ...
    Private Sub LinkLabel7_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel7.LinkClicked
        ...
        If WinAppSdkUi = "1" Then              'WinAppSdk弹窗
            Dim InstallLocation As String = My.Computer.Registry.GetValue("HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Uninstall\WFLtool", "InstallLocation", Nothing)
            Shell(InstallLocation + "\MessageBox.exe ""全名: WFL Tool (x64)                                      版本类别: 正式版" & vbCrLf & "分支: AMD64.Tree4-Main.Release" & vbCrLf & "编译日期：" + releasedate + vbCrLf & "" & vbCrLf & "WinAppSdk 模块由 Bilibili@空糖_SuGar (UID:438929715) 提供支持" & vbCrLf & "" & vbCrLf & "电脑功能启动器是 WFL Tool 的中文名"" ""更多信息"" 0 0 0", AppWinStyle.NormalFocus, False, -1)
        Else              '旧版弹窗
legacy:
            MsgBox("全名: WFL Tool (x64) for EOS OS       版本类别: 正式版 - .NET Fx 4.8 版" & vbCrLf & "分支: AMD64.Tree4-Main.Release" & vbCrLf & "编译日期：" + releasedate + vbCrLf & "" & vbCrLf & "WinAppSdk 模块由 Bilibili@空糖_SuGar (UID:438929715) 提供支持" & vbCrLf & "" & vbCrLf & "电脑功能启动器是 WFL Tool 的中文名", MsgBoxStyle.OkOnly, "更多信息")
        End If
    End Sub

    Private Sub LinkLabel8_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel8.LinkClicked
        Label5.Text = "大事记：" & vbCrLf & "2021/5/9 发布第一个版本(V2.0.0)" & vbCrLf & "2022/7/7 发布第一个64位版本(V7.0.0.0)" & vbCrLf & "2023/1/10 (更新日期) 基于.NET Fx 4.5.2 重构" & vbCrLf & "2022/12/6 (更新日期:2023/01/22) x64 版本源码丢" & vbCrLf & "失，应用重写" & vbCrLf & "2023/05/25 编译 主要名字更名英文 WFL Tool" & vbCrLf & "2024/01/01 编译 应用界面翻新工作基本完成" & vbCrLf & "2025/08/06 编译 更换新图标" & vbCrLf & "2025/11/25 推出 .net 10 版本支持暗色"
