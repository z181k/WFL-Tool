...
Public Class Form9
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        Dim upginfo As String = "RTM 版本(9120.1):" & vbCrLf & vbCrLf & "-新功能：" & vbCrLf & "1.切换框架到受支持且更安全的 .netFx 4.6.2 和 4.8" & vbCrLf & "2.增加自定义应用启动界面功能 (没有设置界面，去帮助看怎么用)" & vbCrLf & "3.正在测试将更新本程序从系统更新菜单中删除" & vbCrLf & "　因此您可能会在不同设备看到该功能有不同的呈现效果" & vbCrLf & "　如果您的设备较新，应可以很快看到此更改" & vbCrLf & "4.添加设备管理器错误代码的帮助" & vbCrLf & "5.部分在线界面改为由 Webview2 渲染" & vbCrLf & "6.WFL Tool 5 周年页面上线" & vbCrLf & vbCrLf & "-修复：" & vbCrLf & "1.解决更多功能任务管理器无法打开造成任务管理器假死问题" & vbCrLf & "2.解决企业屏蔽应用选项时右上角文字异常问题" & vbCrLf & "3.移除了上个版本在 Win7/Vista 存在严重兼容性问题的功能" & vbCrLf & "4.解决在已有 WFL Tool 运行的情况下安装/卸载失败问题" & vbCrLf & "5.解决内存诊断无法打开问题" & vbCrLf & "6.修复更新日志界面可能会意外出现引号问题" & vbCrLf & "7.其他细节优化"
