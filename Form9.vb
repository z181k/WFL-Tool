...
Public Class Form9
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        ...
        Dim upginfo As String = """RTM 版本(9072.1):" & vbCrLf & "新功能：" & vbCrLf & "1.切换框架到受支持且更安全的 .netFx 4.6.2 和 4.8" & vbCrLf & "2.增加自定义应用启动界面功能 (没有设置界面，去帮助看怎么用)" & vbCrLf & "3." & vbCrLf & "4." & vbCrLf & "修复：" & vbCrLf & "1.解决更多功能任务管理器无法打开造成任务管理器假死问题" & vbCrLf & "2.解决企业屏蔽应用选项时右上角文字异常问题" & vbCrLf & "3.移除了上个版本在 Win7/Vista 存在严重兼容性问题的功能" & vbCrLf & "4.解决在已有 WFL Tool 运行的情况下安装/卸载失败问题" & vbCrLf & "5.解决内存诊断无法打开问题"""
